    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-indigo-100 selection:text-indigo-900">
        ...
        <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
          ...
          <div>
            {authenticated ? (
              <Link 
                href="/dashboard"
                className="inline-flex items-center justify-center h-10 px-6 rounded-md bg-slate-900 text-white text-sm font-bold hover:bg-slate-800 transition-all shadow-sm"
              >
                Dashboard
              </Link>
            ) : (
      ...
      <section className="px-6 py-24 md:py-32 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-bold tracking-tight text-slate-900 mb-8 leading-[1.1]">
            Next-Generation <br />
            <span className="text-[#C5A059]">Asset Tokenization.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button 
              ...
              className="inline-flex items-center justify-center h-12 px-8 rounded-md bg-slate-900 text-white font-bold hover:bg-slate-800 transition-all group"
            >
              Get Started
      ...
      <section id="assets" className="px-6 py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <h2 className="text-sm font-bold text-gold uppercase tracking-widest mb-3">Asset Classes</h2>
            <h3 className="text-3xl font-serif font-bold text-slate-900">Portfolio Selection</h3>
          </div>
      ...
      <section id="technology" className="px-6 py-24 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
          <div className="flex-1">
            <h2 className="text-sm font-bold text-gold uppercase tracking-widest mb-3">Architecture</h2>
            <h3 className="text-3xl font-serif font-bold text-slate-900 mb-8">Built for Reliability</h3>
          ...
          <div className="flex-1 w-full bg-slate-900 rounded-2xl p-8 text-white">
            ...
            <div className="space-y-4 font-mono text-sm leading-relaxed">
              <p className="text-gold"># Asset Metadata Contract</p>
      ...
      <footer className="px-6 py-12 border-t border-slate-100 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded bg-[#C5A059] flex items-center justify-center">
              <span className="text-white font-serif font-black text-[10px]">T</span>
            </div>
            <span className="text-sm font-serif font-bold tracking-tight text-slate-900">Terravio</span>
          </div>
...
function TechItem({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="flex gap-4">
      <div className="mt-1 w-8 h-8 flex-shrink-0 rounded bg-slate-50 flex items-center justify-center text-gold border border-slate-100">
        {icon}
      </div>
      <div>
