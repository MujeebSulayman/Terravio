        ...
        <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
          ...
          <div>
            {authenticated ? (
              ...
              <button
                onClick={login}
                className="inline-flex items-center cursor-pointer justify-center h-10 px-6 rounded-md bg-slate-900 text-white text-xs font-bold uppercase tracking-widest hover:bg-slate-800 transition-all shadow-sm"
              >
                Launch App
              </button>
            )}
      ...
      <section className="relative px-6 pt-24 pb-32 md:pt-40 md:pb-48 max-w-7xl mx-auto overflow-hidden">
        <div className="max-w-4xl relative z-10">
          ...
          <motion.p
            ...
            className="text-xl md:text-xl  text-slate-500 mb-12 leading-relaxed max-w-2xl font-light"
          >
